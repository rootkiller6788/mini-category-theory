...
def targets : List (String × String) := [
  ...
  ("MiniAdjunction/Properties/Invariants.lean:7", "DONE"),
  ("MiniAdjunction/Theorems/UniversalProperties.lean:7", "DONE"),
  ("MiniAdjunction/Bridges/ToComputation.lean:7", "DONE")
]
...
#eval show IO Unit from do
  ...
  IO.println s!"Harvard: {done}/{total} done ({pct}%), {stub} stubs"
